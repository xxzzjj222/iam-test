...
values
(1001, null, '00000000-0000-0000-0000-000000000000', now(), null, null, 'AIThesis Web前台', 'AIThesis_Web', 'front', 'web', 1, 1, 1, 'AIThesis web前台'),
(1002, null, '00000000-0000-0000-0000-000000000000', now(), null, null, 'AIThesis 小程序普通用户', 'AIThesis_Applet_User', 'front', 'applet', 1, 2, 1, 'AIThesis小程序普通用户端'),
(1003, null, '00000000-0000-0000-0000-000000000000', now(), null, null, 'AIThesis 小程序商务', 'AIThesis_Applet_Business', 'front', 'applet', 0, 3, 1, 'AIThesis小程序商务端'),
(1004, null, '00000000-0000-0000-0000-000000000000', now(), null, null, 'AIThesis App', 'AIThesis_App', 'front', 'app', 0, 4, 1, 'AIThesis App'),
(1005, null, '00000000-0000-0000-0000-000000000000', now(), null, null, 'AIThesis 管理后台', 'AIThesis_Management', 'management', 'web', 0, 5, 1, 'AIThesis后台管理'),
(1006, null, '00000000-0000-0000-0000-000000000000', now(), null, null, 'AIEnglish H5', 'AIEnglish_H5', 'front', 'h5', 1, 6, 1, 'AIEnglish H5'),
(1007, null, '00000000-0000-0000-0000-000000000000', now(), null, null, 'AIEnglish 小程序', 'AIEnglish_MiniApp', 'front', 'applet', 1, 7, 1, 'AIEnglish小程序'),
(1008, null, '00000000-0000-0000-0000-000000000000', now(), null, null, 'AIEnglish App', 'AIEnglish_App', 'front', 'app', 1, 8, 1, 'AIEnglish App'),
(1009, null, '00000000-0000-0000-0000-000000000000', now(), null, null, 'AIEnglish 管理后台', 'AIEnglish_Management', 'management', 'web', 0, 9, 1, 'AIEnglish后台管理'),
...
values
(3001, null, '00000000-0000-0000-0000-000000000000', now(), null, null, 'iam_internal', '4E738CA5563C06CFD0018299933D58DB1DD8BF97F6973DC99BF6CDC64B5550BD', 'IAM内部客户端', 'client_credentials', 'user.read,user.write,stat.write', 1, 7200);
